...
boards = [board for board in things] #TASK 5.3.(c) -- replace [] by a list comprehension
...
pausingPlayers = \
    [event for event in events if (event.__class__ == Pause)] # TASK 5.3.(b) -- replace [] by a list comprehension
